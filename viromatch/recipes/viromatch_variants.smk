...
# var_repair_fastq_files
# var_copy_reference_genomes
# var_index_reference_genomes
# var_nuc_mapping
# var_write_nuc_bam_file
# var_name_sort_bam
# var_fix_mate_bam
# var_coordinate_sort_bam
# var_markdup_bam
# var_write_mpileup_file
# var_mpileup_to_snp
# var_mpileup_to_indel
# var_mpileup_read_counts
...
rule all:
    input:
        ...
        'viromatch_results/var_repair_fastq_files/INPUT.r1.viral.mapped.repaired.fastq',
        'viromatch_results/var_repair_fastq_files/INPUT.r2.viral.mapped.repaired.fastq',
        'viromatch_results/var_copy_reference_genomes/NC_001664.fna.bwt',
        'viromatch_results/var_copy_reference_genomes/NC_001798.fna.bwt',
        'viromatch_results/var_copy_reference_genomes/NC_001806.fna.bwt',
        'viromatch_results/var_copy_reference_genomes/NC_006273.fna.bwt',
        'viromatch_results/var_mpileup_to_snp/NC_001664.fna.snp.vcf',
        'viromatch_results/var_mpileup_to_snp/NC_001798.fna.snp.vcf',
        'viromatch_results/var_mpileup_to_snp/NC_001806.fna.snp.vcf',
        'viromatch_results/var_mpileup_to_snp/NC_006273.fna.snp.vcf',
        'viromatch_results/var_mpileup_to_indel/NC_001664.fna.indel.vcf',
        'viromatch_results/var_mpileup_to_indel/NC_001798.fna.indel.vcf',
        'viromatch_results/var_mpileup_to_indel/NC_001806.fna.indel.vcf',
        'viromatch_results/var_mpileup_to_indel/NC_006273.fna.indel.vcf',
        'viromatch_results/var_mpileup_read_counts/NC_001664.fna.counts',
        'viromatch_results/var_mpileup_read_counts/NC_001798.fna.counts',
        'viromatch_results/var_mpileup_read_counts/NC_001806.fna.counts',
        'viromatch_results/var_mpileup_read_counts/NC_006273.fna.counts',
...
# :::::::::::::::::::::::::::::::::::::::::::::
#  V A R   R E P A I R   F A S T Q   F I L E S
# :::::::::::::::::::::::::::::::::::::::::::::

# Dependencies:
# + repair_fastq.py

rule var_repair_fastq_files:
    input:
        fastq1 = 'viromatch_results/viral_nuc_write_mapped_fastq/INPUT.r1.viral.mapped.fastq',
        fastq2 = 'viromatch_results/viral_nuc_write_mapped_fastq/INPUT.r2.viral.mapped.fastq'
    output:
        summary = 'viromatch_results/var_repair_fastq_files/repair_summary.txt',
        orphans = temp('viromatch_results/var_repair_fastq_files/orphans.fasta'),
        mate1 = temp('viromatch_results/var_repair_fastq_files/INPUT.r1.viral.mapped.repaired.fastq'),
        mate2 = temp('viromatch_results/var_repair_fastq_files/INPUT.r2.viral.mapped.repaired.fastq'),
        cmd = 'viromatch_results/var_repair_fastq_files/var_repair_fastq_files.cmd'
    benchmark:
        'viromatch_results/.viromatch/benchmark/var_repair_fastq_files.benchmark'
    run:
        cmd = ' '.join([
            'repair_fastq.py',
            '--fastq1 {input.fastq1}',
...
# :::::::::::::::::::::::::::::::::::::::::::::::::::::
#  V A R   C O P Y   R E F E R E N C E   G E N O M E S
# :::::::::::::::::::::::::::::::::::::::::::::::::::::

# Dependencies:
# + cp

rule var_copy_reference_genomes:
    input:
        '/usr/share/viromatch/{ref}'
    output:
        reference = 'viromatch_results/var_copy_reference_genomes/{ref}',
        cmd = 'viromatch_results/var_copy_reference_genomes/var_copy_reference_genomes_{ref}.cmd'
    benchmark:
        'viromatch_results/.viromatch/benchmark/var_copy_reference_genomes_{ref}.benchmark'
    run:
        cmd = ' '.join([
            'cp',
            '{input}',
...
# :::::::::::::::::::::::::::::::::::::::::::::::::::::::
#  V A R   I N D E X   R E F E R E N C E   G E N O M E S
# :::::::::::::::::::::::::::::::::::::::::::::::::::::::

# Dependencies:
# + bwa

rule var_index_reference_genomes:
    input:
        'viromatch_results/var_copy_reference_genomes/{ref}'
    output:
        bwt = 'viromatch_results/var_copy_reference_genomes/{ref}.bwt',
        cmd = 'viromatch_results/var_index_reference_genomes/var_index_reference_genomes_{ref}.cmd'
    benchmark:
        'viromatch_results/.viromatch/benchmark/var_index_reference_genomes_{ref}.benchmark'
    log:
        'viromatch_results/.viromatch/log/var_index_reference_genomes_{ref}.log'
    run:
        cmd = ' '.join([
            'bwa',
            'index',
...
# :::::::::::::::::::::::::::::::
#  V A R   N U C   M A P P I N G
# :::::::::::::::::::::::::::::::

# Dependencies:
# + bwa

rule var_nuc_mapping:
    input:
        reference = 'viromatch_results/var_copy_reference_genomes/{ref}',
        bwt = 'viromatch_results/var_copy_reference_genomes/{ref}.bwt',
        mate1 = 'viromatch_results/var_repair_fastq_files/INPUT.r1.viral.mapped.repaired.fastq',
        mate2 = 'viromatch_results/var_repair_fastq_files/INPUT.r2.viral.mapped.repaired.fastq'
    output:
        sam = 'viromatch_results/var_nuc_mapping/{ref}.sam',
        cmd = 'viromatch_results/var_nuc_mapping/var_nuc_mapping_{ref}.cmd'
    log:
        'viromatch_results/.viromatch/log/var_nuc_mapping_{ref}.log'
    benchmark:
        'viromatch_results/.viromatch/benchmark/var_nuc_mapping_{ref}.benchmark'
    run:
        cmd = ' '.join([
            'bwa',
            'mem',
            '{input.reference}',
            '{input.mate1} {input.mate2} > {output.sam} 2> {log}'
        ])
        shell('echo "' + cmd + '" > {output.cmd}')
        shell(cmd)
...
# :::::::::::::::::::::::::::::::::::::::::::::
#  V A R   W R I T E   N U C   B A M   F I L E
# :::::::::::::::::::::::::::::::::::::::::::::

# Dependencies:
# + samtools

rule var_write_nuc_bam_file:
    input:
        sam = 'viromatch_results/var_nuc_mapping/{ref}.sam',
    output:
        bam = 'viromatch_results/var_write_nuc_bam_file/{ref}.bam',
        cmd = 'viromatch_results/var_write_nuc_bam_file/var_write_nuc_bam_{ref}.cmd'
    benchmark:
        'viromatch_results/.viromatch/benchmark/var_write_nuc_bam_{ref}.benchmark'
    run:
        cmd = ' '.join([
            'samtools',
            'view',
...
# ::::::::::::::::::::::::::::::::::
#  V A R   N A M E  S O R T   B A M
# ::::::::::::::::::::::::::::::::::

# Dependencies:
# + samtools

rule var_name_sort_bam:
    input:
        bam = 'viromatch_results/var_write_nuc_bam_file/{ref}.bam',
    output:
        sort = 'viromatch_results/var_name_sort_bam/{ref}.nsort.bam',
        cmd = 'viromatch_results/var_name_sort_bam/var_name_sort_bam_{ref}.cmd'
    benchmark:
        'viromatch_results/.viromatch/benchmark/var_name_sort_bam_{ref}.benchmark'
    run:
        cmd = ' '.join([
            'samtools',
            'sort',
...
# :::::::::::::::::::::::::::::::::
#  V A R   F I X   M A T E   B A M
# :::::::::::::::::::::::::::::::::

# Dependencies:
# + samtools

rule var_fix_mate_bam:
    input:
        sort = 'viromatch_results/var_name_sort_bam/{ref}.nsort.bam',
    output:
        fixmate = 'viromatch_results/var_fix_mate_bam/{ref}.fixmate.bam',
        cmd = 'viromatch_results/var_fix_mate_bam/var_fix_mate_bam_{ref}.cmd'
    benchmark:
        'viromatch_results/.viromatch/benchmark/var_fix_mate_bam_{ref}.benchmark'
    run:
        cmd = ' '.join([
            'samtools',
            'fixmate',
...
# :::::::::::::::::::::::::::::::::::::::::::::::
#  V A R   C O O R D I N A T E   S O R T   B A M
# :::::::::::::::::::::::::::::::::::::::::::::::

# Dependencies:
# + samtools

rule var_coordinate_sort_bam:
    input:
        fixmate = 'viromatch_results/var_fix_mate_bam/{ref}.fixmate.bam',
    output:
        sort = 'viromatch_results/var_coordinate_sort_bam/{ref}.csort.bam',
        cmd = 'viromatch_results/var_coordinate_sort_bam/var_coordinate_sort_bam_{ref}.cmd'
    benchmark:
        'viromatch_results/.viromatch/benchmark/var_coordinate_sort_bam_{ref}.benchmark'
    run:
        cmd = ' '.join([
            'samtools',
            'sort',
...
# :::::::::::::::::::::::::::::::
#  V A R   M A R K D U P   B A M
# :::::::::::::::::::::::::::::::

# Dependencies:
# + samtools

rule var_markdup_bam:
    input:
        sort = 'viromatch_results/var_coordinate_sort_bam/{ref}.csort.bam',
    output:
        markdup = 'viromatch_results/var_markdup_bam/{ref}.markdup.bam',
        cmd = 'viromatch_results/var_markdup_bam/var_markdup_bam_{ref}.cmd'
    benchmark:
        'viromatch_results/.viromatch/benchmark/var_markdup_bam_{ref}.benchmark'
    run:
        cmd = ' '.join([
            'samtools',
            'markdup',
...
# :::::::::::::::::::::::::::::::::::::::::::::
#  V A R   W R I T E   M P I L E U P   F I L E
# :::::::::::::::::::::::::::::::::::::::::::::

# Dependencies:
# + samtools

rule var_write_mpileup_file:
    input:
        markdup = 'viromatch_results/var_markdup_bam/{ref}.markdup.bam',
        reference = 'viromatch_results/var_copy_reference_genomes/{ref}'
    output:
        mpileup = 'viromatch_results/var_write_mpileup_file/{ref}.mpileup',
        cmd = 'viromatch_results/var_write_mpileup_file/var_write_mpileup_file_{ref}.cmd'
    log:
        'viromatch_results/.viromatch/log/var_write_mpileup_file_{ref}.log'
    benchmark:
        'viromatch_results/.viromatch/benchmark/var_write_mpileup_file_{ref}.benchmark'
    run:
        cmd = ' '.join([
            'samtools',
            'mpileup',
...
# :::::::::::::::::::::::::::::::::::::
#  V A R   M P I L E U P   T O   S N P
# :::::::::::::::::::::::::::::::::::::

# Dependencies:
# + varscan

rule var_mpileup_to_snp:
    input:
        mpileup = 'viromatch_results/var_write_mpileup_file/{ref}.mpileup',
    output:
        vcf = 'viromatch_results/var_mpileup_to_snp/{ref}.snp.vcf',
        cmd = 'viromatch_results/var_mpileup_to_snp/var_mpileup_to_snp_{ref}.cmd'
    log:
        'viromatch_results/.viromatch/log/var_mpileup_to_snp_{ref}.log'
    benchmark:
        'viromatch_results/.viromatch/benchmark/var_mpileup_to_snp_{ref}.benchmark'
    run:
        cmd = ' '.join([
            'varscan',
            'mpileup2snp',
...
# :::::::::::::::::::::::::::::::::::::::::
#  V A R   M P I L E U P   T O   I N D E L
# :::::::::::::::::::::::::::::::::::::::::

# Dependencies:
# + varscan

rule var_mpileup_to_indel:
    input:
        mpileup = 'viromatch_results/var_write_mpileup_file/{ref}.mpileup',
    output:
        vcf = 'viromatch_results/var_mpileup_to_indel/{ref}.indel.vcf',
        cmd = 'viromatch_results/var_mpileup_to_indel/var_mpileup_to_indel_{ref}.cmd'
    log:
        'viromatch_results/.viromatch/log/var_mpileup_to_indel_{ref}.log'
    benchmark:
        'viromatch_results/.viromatch/benchmark/var_mpileup_to_indel_{ref}.benchmark'
    run:
        cmd = ' '.join([
            'varscan',
            'mpileup2indel',
...
# :::::::::::::::::::::::::::::::::::::::::::::::
#  V A R   M P I L E U P   R E A D   C O U N T S
# :::::::::::::::::::::::::::::::::::::::::::::::

# Dependencies:
# + varscan

rule var_mpileup_read_counts:
    input:
        mpileup = 'viromatch_results/var_write_mpileup_file/{ref}.mpileup',
    output:
        counts = 'viromatch_results/var_mpileup_read_counts/{ref}.counts',
        cmd = 'viromatch_results/var_mpileup_read_counts/var_mpileup_read_counts_{ref}.cmd'
    log:
        'viromatch_results/.viromatch/log/var_mpileup_read_counts_{ref}.log'
    benchmark:
        'viromatch_results/.viromatch/benchmark/var_mpileup_read_counts_{ref}.benchmark'
    run:
        cmd = ' '.join([
            'varscan',
            'readcounts',
