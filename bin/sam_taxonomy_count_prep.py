...
def eval_cli_arguments():
    ...
    parser = argparse.ArgumentParser(
        ...
        prog='sam_taxonomy_count_prep.py',
        add_help=False
    )
...
def write_taxonomy(fh_out, sam, end, taxonomy):
...
def associate_taxonomy_with_hits(taxonomy, arguments):
    ...
    write_taxonomy(fh_out=fh_out, sam=arguments.sam1, end='R1', taxonomy=taxonomy)
    write_taxonomy(fh_out=fh_out, sam=arguments.sam2, end='R2', taxonomy=taxonomy)
...
if __name__ == '__main__':
    ...
    # Provided R1 and R2 filtered/passed SAM files, we will associate
    # taxonomy for these best hits and prepare a file for downstream read
